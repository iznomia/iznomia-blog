...
积分上限函数 $\Phi(x)=\displaystyle\int_{a}^x f(x)\d x$。若 $f(x)$ 在 $[a,b]$ 连续，那么 $\Phi(x)$ 在 $[a,b]$ 上可导，且 $\Phi'(x)=f(x)$。
...
<iframe src="/wiki/maths/jlucal2022.pdf" height="900px" width="100%"></iframe>
